...
function PrintAnsweredToAllQuestions()
{
	...
	HideQuestionMenu();
	HideRetireButton();
	$('#idModalNotificationText').text('Vous avez répondu à toutes les questions');
...
function PrintTimeOver()
{
	...
	HideQuestionMenu();
	HideRetireButton();
	$('#idModalNotificationText').text('Temps expiré');
	$('#idModalNotification').modal('show');
...
function PrintVerifyFailed()
{
	...
	$('#idModalNotificationText').text('Certaines questions ont des réponses incomplètes. Vous devez répondre pour continuer');
	$('#idModalNotification').modal('show');
}
...
function PrintAskAbandonQuiz()
{
	...
	$('#idModalConfirmationText').text('Etes-vous sûr ?');
...
function PrintAskConfirmOK(InitQuestion)
{
	...
	$('#idModalConfirmationText').text('Confirmez-vous votre réponse ?');
	$('#idModalConfirmation').modal('show');
}
...
function PrintAskVerifyQuest()
{
	...
	$('#idModalConfirmationText').text('Êtes-vous sûr de confirmer toutes vos réponses ?');
	$('#idModalConfirmation').modal('show');
}
...
function PrintRegistrationSuccess()
{
	...
	$('#idModalNotificationText').text('L&apos;enregistrement a réussi');
	$('#idModalNotification').modal('show');
}

function PrintDoneBefore(questionIndex)
{
	PrintWarning('Vous avez déjà répondu à cette question !', questionIndex);
}

function PrintQuestionTimeIsElapsed(questionIndex)
{
	PrintWarning('Le temps de réponse à cette question est écoulé', questionIndex);
}

function PrintNeedToAnswer(questionIndex)
{
	PrintWarning('Réponse incomplète.', questionIndex);  // "Prima di proseguire devi rispondere alla domanda"
}

function PrintNeedToAnswerAllItem(questionIndex)
{
	PrintWarning('Réponse incomplète. Veuillez choisir tous les items', questionIndex);  // "Prima di proseguire devi rispondere al tutte le uscite"
}

function PrintNeedToAnswerCorrectly(questionIndex)
{
	PrintWarning('Avant la prochaine étape, vous devez y répondre correctement', questionIndex);  // "Prima di proseguire devi rispondere alla domanda in modo corretto"
}
...
{
	PrintGlobalError('Une erreur lors du chargement de la page ou l&apos;actualisation de la page n&apos;est pas autorisée');
}
...
{
	var copyRightMsg = "Ce test a été créé ";
